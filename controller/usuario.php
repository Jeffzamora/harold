<?php
    ...
    switch($_GET["op"]){
        ...
        case "logout":
            $usuario->update_login();
            break;

        case "reporte":
            $datos=$usuario->obtenerUsuariosConectados();
            $data= Array();
            foreach($datos as $row){
                $sub_array = array();
                $sub_array[] = $row["usu_nom"];
                ...
                if ($row["hora_fin"]=="No realizó cierre de sesión"){
                    $sub_array[] = '<span class="label label-pill label-warning">No cerro sesion</span>';
                }else{
                    $sub_array[] = $row["hora_fin"];
                }

                if ($row["tiempo_conexion"]=="No realizó cierre de sesión"){
                    $sub_array[] = '<span class="label label-pill label-warning">No cerro sesion</span>';
                }else{
                    $sub_array[] = $row["tiempo_conexion"];
                }
