    ...
    <div class="container-fluid">
        ...
        <div class="site-header-content">
            <div class="site-header-content-in">
                <div class="site-header-shown">
                    <div class="dropdown user-menu">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
                            ...
                            <a id="sesion" class="dropdown-item" href="../../controller/usuario.php?op=logout"><span class="font-icon glyphicon glyphicon-log-out"></span>Cerrar Sesion</a>
                        </div>
                    </div>
                </div>
                ...
                <input type="hidden" id="correo" value="<?php echo $_SESSION["usu_correo"] ?>"><!-- Rol del Usuario-->
 
                <div class="dropdown dropdown-typical">
                    <a href="#" class="dropdown-toggle no-arr">
                        <span class="font-icon font-icon-user"></span>
                        <span class="lblcontactonomx"><?php echo $_SESSION["usu_nom"] ?> <?php echo $_SESSION["usu_ape"] ?>  <?php echo $_SESSION["usu_correo"] ?></span>
                    </a>
                </div>
